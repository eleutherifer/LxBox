...
- изменены наборы конечных точек для WARP (например, в метро Wi-Fi на портах 443 и 8443 HTTP/3 (QUIC, MASQUE UDP) не работает, а на остальных портах из зарубежных на HTTP/3 работают только deepseek.com и pupi.org),  
